...
public final class HelloServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<dev.jihogrammer.grpc.hello.HelloRequest,
      dev.jihogrammer.grpc.hello.HelloResponse> getHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "hello",
      requestType = dev.jihogrammer.grpc.hello.HelloRequest.class,
      responseType = dev.jihogrammer.grpc.hello.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<dev.jihogrammer.grpc.hello.HelloRequest,
      dev.jihogrammer.grpc.hello.HelloResponse> getHelloMethod() {
    io.grpc.MethodDescriptor<dev.jihogrammer.grpc.hello.HelloRequest, dev.jihogrammer.grpc.hello.HelloResponse> getHelloMethod;
    if ((getHelloMethod = HelloServiceGrpc.getHelloMethod) == null) {
      synchronized (HelloServiceGrpc.class) {
        if ((getHelloMethod = HelloServiceGrpc.getHelloMethod) == null) {
          HelloServiceGrpc.getHelloMethod = getHelloMethod =
              io.grpc.MethodDescriptor.<dev.jihogrammer.grpc.hello.HelloRequest, dev.jihogrammer.grpc.hello.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "hello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  dev.jihogrammer.grpc.hello.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  dev.jihogrammer.grpc.hello.HelloResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void hello(dev.jihogrammer.grpc.hello.HelloRequest request,
        io.grpc.stub.StreamObserver<dev.jihogrammer.grpc.hello.HelloResponse> responseObserver) {
  ...
  public static final class HelloServiceStub
    ...
    /**
     */
    public void hello(dev.jihogrammer.grpc.hello.HelloRequest request,
        io.grpc.stub.StreamObserver<dev.jihogrammer.grpc.hello.HelloResponse> responseObserver) {
  ...
  public static final class HelloServiceBlockingStub
    ...
    /**
     */
    public dev.jihogrammer.grpc.hello.HelloResponse hello(dev.jihogrammer.grpc.hello.HelloRequest request) {
  ...
  public static final class HelloServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<dev.jihogrammer.grpc.hello.HelloResponse> hello(
        dev.jihogrammer.grpc.hello.HelloRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_HELLO:
          serviceImpl.hello((dev.jihogrammer.grpc.hello.HelloRequest) request,
              (io.grpc.stub.StreamObserver<dev.jihogrammer.grpc.hello.HelloResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              dev.jihogrammer.grpc.hello.HelloRequest,
              dev.jihogrammer.grpc.hello.HelloResponse>(
  ...
  private static abstract class HelloServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return dev.jihogrammer.grpc.hello.HelloServiceOuterClass.getDescriptor();
    }
